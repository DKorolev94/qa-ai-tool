...
В рекомендации к проблеме с тегами обязательно укажи конкретный итоговый список тегов который должен быть, например: "Замените теги на: smoke, auth, negative". Не пиши просто "добавьте/удалите теги" — давай конкретный готовый список.
