...
Теги ВСЕГДА проверяй — обязательная часть ревью, не пропускай.

Максимум 4–5 тегов. Исходя из содержания шагов сформируй итоговый список тегов который должен быть.

Флажь если текущие теги не совпадают с правильным списком. Типичные теги: `smoke`, `regression`, `auth`, `api`, `ui`, `negative`, `positive`, название функции/модуля.

В рекомендации ВСЕГДА укажи конкретный итоговый список: "Замените теги на: smoke, auth, negative".
