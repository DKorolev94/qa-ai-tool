...
- тег не соответствует содержанию шагов
- тегов больше 5
- очевидно нужный тег отсутствует

В рекомендации обязательно укажи конкретный итоговый список тегов, например: "Замените теги на: smoke, auth, negative". Не пиши просто "добавьте/удалите теги" — давай конкретный готовый список.
